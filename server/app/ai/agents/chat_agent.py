...
chat_agent = create_agent(
    ...
    system_prompt=(
        ...
        "- When an active document is scoped (indicated by `[Active Document Scope: \"<filename>\"]`), you MUST answer strictly and exclusively based on that document. DO NOT answer from memory of previously discussed documents in the chat history. Call `search_user_documents` with that document's ID.\n"
